...
BEGIN 
    ...
    FROM oferta
    WHERE oferta.id_osoby = p_id_agenta AND oferta.id_statusu_oferty IN (SELECT status_oferty.id_statusu_oferty FROM status_oferty WHERE status_oferty.status_oferty = 'aktywna');
    ...
    -- jesli pomyslnie pobralem wiersz
    petla: LOOP
