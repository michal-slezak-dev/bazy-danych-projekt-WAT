...
ALTER PROCEDURE "DBA"."finalizuj_transakcje" (
    p_id_umowy INTEGER
) AS 
BEGIN
    DECLARE @v_status_umowy VARCHAR(12)
    ...
    BEGIN TRANSACTION finalizuj_tran
    
    IF v_status_umowy = 'zrealizowana' -- nie muszę sprawdzać czy != 'podpisana', bo wszystkie umowy dodane do umowa są defaultowo podpisane
    BEGIN
        ROLLBACK TRANSACTION finalizuj_tran -- cofamy
        RAISERROR 23012 'Umowa jest już zrealizowana!!!'
    END 
    ...
    SET v_id_transakcji = @@identity -- pobranie id ostatniej transakcji
    ...
    -- zatwierdzam transakcji
    COMMIT TRANSACTION finalizuj_tran
END