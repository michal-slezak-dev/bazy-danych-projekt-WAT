...
IF p_update LIKE 'T' THEN
    ...
    IF p_id_agenta != v_id_obecnego_agenta THEN
        RAISERROR 23000 'Nie możesz zaktualizować agenta przypisanego do danej oferty!';
    END IF;    
    ...
    ELSE -- nie ma aktywnej oferty, więc nie ma co aktualizować, więc daje error i info o tym
        ...
        RAISERROR 23000 'Aktywna oferta, którą chcesz zaktualizować nie istnieje!';
    END IF;
